class Backbone(object):
    ...
    def __init__(self, backbone):
        ...
        self.custom_objects = {
            ...
            '_focal'           : losses.focal(),
            'Split1'           : layers.Split1(),
            'Split2'           : layers.Split2(),
            'Split3'           : layers.Split3(),
            'Split4'           : layers.Split4(),
            'Split5'           : layers.Split5(),
            'OneByOneMergeConv3D' : layers.OneByOneMergeConv3D(),
            'OneByOneMerge5_2D': layers.OneByOneMerge5_2D(),
            'OneByOneMerge3_2D': layers.OneByOneMerge3_2D(),
