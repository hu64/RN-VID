...
allowed_backbones = {'densenet121': [6, 12, 24, 16], 'densenet121-flow': [6, 12, 24, 16], 'densenet169': [6, 12, 32, 32], 'densenet201': [6, 12, 48, 32]}
...
class DenseNetBackbone(Backbone):
    ...
    def download_imagenet(self):
        ...
        weights_url = origin + file_name.format(self.backbone.replace('-flow', ''))
